        ...
        <Dialog.Portal>
            ...
            <Dialog.Content className='fixed drop-shadow-md border border-neutral-600 top-[50%] left-[50%] max-h-full md:max-h-[85vh]  w-full md:w-[90vw] md:max-w-[450px] translate-x-[-50%]  translate-y-[-50%] rounded-md bg-neutral-800 p-[25px] focus-outline-none'>
                ...
                <Dialog.Close asChild>
                    <button>
                        <IoMdClose className='absolute inline-flex  top-[10px] right-[10px] text-neutral-500 hover:text-neutral-50 w-[26px] h-[26px] appearance-none items-center justify-center rounded-full focus:outline-none '/>
                    </button>
                </Dialog.Close>
            </Dialog.Content>
        </Dialog.Portal>
